...
public class LaserTrigger : ModelEntity
{
	...
	{
		Capsule TriggerCapsule = new Capsule( Vector3.Zero, Rotation.Forward * length, 0.2f );
		SetupPhysicsFromCapsule( PhysicsMotionType.Keyframed, TriggerCapsule );
	}
